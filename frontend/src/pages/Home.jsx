...
function Home() {
  ...
  return (<div className="home">
    <section className="hero"><div className="container"><div className="hero-content">
      ...
      <div className="hero-actions"><Link to="/browse" className="btn btn-primary btn-lg"><FiPlay/> Start Watching</Link>{!isAuthenticated && <Link to="/register" className="btn btn-secondary btn-lg">Create Account</Link>}</div>
